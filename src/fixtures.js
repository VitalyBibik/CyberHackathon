  ...
  mainText: [
    {
      ...
      text: [
        ...
        'Запустите приложение и надиктуйте своё послание. Алгоритм автоматически преобразует его в требуемый вид. Возможно потребуется предоставить разрешение на использование микрофона. Следуйте инструкциям и внимательно проверьте перед отправкой.',
